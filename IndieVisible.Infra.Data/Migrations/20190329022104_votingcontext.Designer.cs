...
namespace IndieVisible.Infra.Data.Migrations
{
    ...
    [Migration("20190329022104_votingcontext")]
    partial class votingcontext
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IndieVisible.Domain.Models.UserVote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id");
            ...
            modelBuilder.Entity("IndieVisible.Domain.Models.VotingContext", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id");
                    ...
                    b.ToTable("VotingContexts");

                    b.HasData(
                        new { Id = new Guid("1fee0e42-7cfb-4438-96f9-4dbee6019de9"), CreateDate = new DateTime(2019, 3, 28, 23, 21, 3, 949, DateTimeKind.Local), Description = "Ideas for improvement on the community.", Title = "IndieVisible Ideas", Type = 0, UserId = new Guid("00000000-0000-0000-0000-000000000000") }
                    );
                });

            modelBuilder.Entity("IndieVisible.Domain.Models.VotingItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id");
            ...
            modelBuilder.Entity("IndieVisible.Domain.Models.VotingItemComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id");
            ...
            modelBuilder.Entity("IndieVisible.Domain.Models.UserVote", b =>
                {
                    b.HasOne("IndieVisible.Domain.Models.VotingItem", "VotingItem")
                        .WithMany("Votes")
            ...
            modelBuilder.Entity("IndieVisible.Domain.Models.VotingItem", b =>
                {
                    b.HasOne("IndieVisible.Domain.Models.VotingContext", "Context")
                        .WithMany("Items")
