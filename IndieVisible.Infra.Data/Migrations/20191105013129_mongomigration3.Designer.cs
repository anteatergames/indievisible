...
namespace IndieVisible.Infra.Data.Migrations
{
    ...
    [Migration("20191105013129_mongomigration3")]
    partial class mongomigration3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IndieVisible.Domain.Models.Game", b =>
                {
                    ...
                    b.Property<string>("CustomEngineName")
            ...
            modelBuilder.Entity("IndieVisible.Domain.Models.GameExternalLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id");
            ...
            modelBuilder.Entity("IndieVisible.Domain.Models.GamificationAction", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = new Guid("c002bd0d-06ff-44de-b4aa-9d3b540cfe28"), Action = 4, CreateDate = new DateTime(2019, 5, 23, 0, 21, 44, 473, DateTimeKind.Local), ScoreValue = 20, UserId = new Guid("0c7e18b2-3682-444d-a62b-30e311e76891") },
                        new { Id = new Guid("cccbd822-5cb7-405c-8539-6ba7e2ded11f"), Action = 5, CreateDate = new DateTime(2019, 5, 23, 0, 21, 44, 473, DateTimeKind.Local), ScoreValue = 50, UserId = new Guid("0c7e18b2-3682-444d-a62b-30e311e76891") },
                        ...
                        new { Id = new Guid("a7139047-a7c6-4d56-a102-a9f103a75438"), Action = 7, CreateDate = new DateTime(2019, 5, 23, 0, 21, 44, 473, DateTimeKind.Local), ScoreValue = 50, UserId = new Guid("0c7e18b2-3682-444d-a62b-30e311e76891") },
                        ...
                        new { Id = new Guid("320332ac-52d2-43e9-a4ec-2378271ef50a"), Action = 9, CreateDate = new DateTime(2019, 10, 6, 21, 16, 0, 0, DateTimeKind.Local), ScoreValue = 20, UserId = new Guid("0c7e18b2-3682-444d-a62b-30e311e76891") },
                        new { Id = new Guid("7295e019-5595-4cc4-8253-f63886dbc7d9"), Action = 10, CreateDate = new DateTime(2019, 10, 6, 21, 16, 0, 0, DateTimeKind.Local), ScoreValue = 5, UserId = new Guid("0c7e18b2-3682-444d-a62b-30e311e76891") },
                        new { Id = new Guid("f7bf51b6-79cf-4588-856f-93c432501d0b"), Action = 11, CreateDate = new DateTime(2019, 10, 6, 21, 16, 0, 0, DateTimeKind.Local), ScoreValue = 30, UserId = new Guid("0c7e18b2-3682-444d-a62b-30e311e76891") },
                        new { Id = new Guid("1746f01e-e673-447e-b0e6-cebfcb7cb621"), Action = 12, CreateDate = new DateTime(2019, 10, 6, 21, 16, 0, 0, DateTimeKind.Local), ScoreValue = 20, UserId = new Guid("0c7e18b2-3682-444d-a62b-30e311e76891") },
                        new { Id = new Guid("827c139b-2399-4602-b56c-b3dd611697b6"), Action = 13, CreateDate = new DateTime(2019, 10, 6, 21, 16, 0, 0, DateTimeKind.Local), ScoreValue = 20, UserId = new Guid("0c7e18b2-3682-444d-a62b-30e311e76891") }
                    );
                });
            ...
            modelBuilder.Entity("IndieVisible.Domain.Models.UserContent", b =>
                {
                    ...
                    b.Property<int>("UserContentType")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(1);
            ...
            modelBuilder.Entity("IndieVisible.Domain.Models.UserProfileExternalLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id");
                    ...
                    b.ToTable("UserProfileExternalLink");
                });
            ...
            modelBuilder.Entity("IndieVisible.Domain.Models.GameExternalLink", b =>
                {
                    b.HasOne("IndieVisible.Domain.Models.Game")
            ...
            modelBuilder.Entity("IndieVisible.Domain.Models.PollVote", b =>
                {
                    b.HasOne("IndieVisible.Domain.Models.Poll")
                        .WithMany("Votes")
                        .HasForeignKey("PollId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("IndieVisible.Domain.Models.UserConnection", b =>
                {
                    b.HasOne("IndieVisible.Domain.Models.UserProfile")
