var TEAMUP=function(){"use strict";function y(){n.container="#teamcontainer";n.isAjax="#isajax";n.caninteract="#caninteract";n.Id="#Id";n.divListTeams="#divListTeams";n.divListMyTeams="#divListMyTeams";n.btnTeamNew=".btn-team-new";n.teamMemberTemplate=".team-member.template";n.formSaveTeam="#frmTeamSave";n.btnSaveTeam="#btnSaveTeam";n.divteamItem=".team-item";n.divMembers="#divMembers";n.teamMember=".team-member";n.teamMemberUserId=".team-member:not(.template) .team-member-userid";n.teamMemberIsLeader=".team-member-isleader";n.teamMemberName=".team-member-name";n.ddlSearchMembers="#ddlSearchMembers";n.divDetails=".div-details";n.divInvitation="#divInvitation";n.txtMyQuote="#txtMyQuote";n.btnAcceptInvitation="#btnAcceptInvitation";n.btnRejectInvitation="#btnRejectInvitation";n.btnEditTeam=".btnEditTeam";n.btnDeleteTeam=".btnDeleteTeam";n.btnDeleteMember=".btnDeleteMember";n.divGames="#divGames";n.divGamesList="#divGamesList";n.divApplication="#divApplication";n.btnCandidateApply="#btnCandidateApply";n.btnAcceptCandidate=".btnAcceptCandidate";n.btnRejectCandidate=".btnRejectCandidate"}function p(){t.container=$(n.container);t.Id=$(n.Id);t.divListTeams=$(n.divListTeams);t.divListMyTeams=$(n.divListMyTeams);t.divInvitation=$(n.divInvitation);t.divGames=$(n.divGames);t.divGamesList=$(n.divGamesList);t.divApplication=$(n.divApplication);s||(f(),t.txtMyQuote=$(n.txtMyQuote))}function w(){t.btnAcceptCandidate=$(n.btnAcceptCandidate);t.btnRejectCandidate=$(n.btnRejectCandidate)}function b(){y();p();u=t.Id.val()===undefined;k();s=$(n.container).find(n.isAjax).val();i=$(n.container).find(n.caninteract).val();t.container.find(n.caninteract).val();u?(st(),c()):(w(),t.divGames.length>0&&lt());r()}function k(){g();u?(d(),ft(),et()):(nt(),tt(),it(),rt(),ut());ot()}function r(){$(".members select.select2").each(function(){$(this).data("select2")===undefined&&$(this).select2({width:"element"})})}function h(){t.ddlSearchMembers.select2({minimumInputLength:2,templateResult:vt});t.ddlSearchMembers.on("select2:select",function(n){var t=n.params.data;$(this).val(null).trigger("change");at(t)})}function d(){t.container.on("click",n.btnTeamNew,function(){i&&ht()})}function g(){t.container.on("click",n.btnSaveTeam,function(n){var r,u;return n.preventDefault(),r=$(this),MAINMODULE.Common.DisableSaveButton(r),u=t.form.valid(),u&&i&&pt(r),!1})}function nt(){t.divMembers.on("click",n.btnAcceptInvitation,function(){var r=$(this),u=$(this).data("url"),i=t.txtMyQuote.val(),f={quote:i};$.post(u,f).done(function(u){MAINMODULE.Common.HandlePointsEarned(u);var f=r.closest(n.divDetails).find(".quote");f.text(i);f.removeClass("d-none");t.divInvitation.remove()})})}function tt(){t.divMembers.on("click",n.btnRejectInvitation,function(){var t=$(this),i=$(this).data("url");$.post(i).done(function(){t.closest(n.teamMember).remove()})})}function it(){t.divApplication.on("click",n.btnCandidateApply,function(){var n=$(this),i=n.data("url"),r=t.divApplication.find(":input").serialize();$.post(i,r).done(function(n){n.success?(MAINMODULE.Common.HandlePointsEarned(n),n.message&&ALERTSYSTEM.ShowSuccessMessage(n.message,function(){n.url&&(window.location=n.url)})):ALERTSYSTEM.ShowWarningMessage(n.message)})})}function rt(){t.divMembers.on("click",n.btnAcceptCandidate,function(){var n=$(this),t=n.data("url");$.post(t).done(function(n){n.success?n.message&&ALERTSYSTEM.ShowSuccessMessage(n.message,function(){n.url&&(window.location=n.url)}):ALERTSYSTEM.ShowWarningMessage(n.message)})})}function ut(){t.divMembers.on("click",n.btnRejectCandidate,function(){var t=$(this),i=$(this).data("url");$.post(i).done(function(){t.closest(n.teamMember).remove()})})}function ft(){t.divListTeams.on("click",n.btnEditTeam,function(n){n.preventDefault();var t=$(this).data("url");i&&ct(t)})}function et(){t.divListTeams.on("click",n.btnDeleteTeam,function(t){t.preventDefault();var i=$(this),r=$(this).data("url"),u=i.data("confirmationmessage"),f=i.data("confirmationtitle"),e=i.data("confirmationbuttontext"),o=i.data("cancelbuttontext");ALERTSYSTEM.ShowConfirmMessage(f,u,e,o,function(){$.ajax({url:r,type:"DELETE"}).done(function(t){t.success?(i.closest(n.divteamItem).remove(),c(),t.message&&ALERTSYSTEM.ShowSuccessMessage(t.message,function(){t.url&&(window.location=t.url)})):ALERTSYSTEM.ShowWarningMessage(t.message)})})})}function ot(){t.container.on("click",n.btnDeleteMember,function(t){console.log("meh");t.preventDefault();var i=$(this),r=$(this).data("url"),u=i.data("confirmationmessage"),f=i.data("confirmationtitle"),o=i.data("confirmationbuttontext"),s=i.data("cancelbuttontext");ALERTSYSTEM.ShowConfirmMessage(f,u,o,s,function(){$.ajax({url:r,type:"DELETE"}).done(function(t){t.success?(i.closest(n.teamMember).remove(),e(),t.message&&ALERTSYSTEM.ShowSuccessMessage(t.message)):ALERTSYSTEM.ShowWarningMessage(t.message)})})})}function st(){t.divListTeams.html(MAINMODULE.Default.SpinnerTop);$.get("/team/list/",function(n){t.divListTeams.html(n)}).done(function(){yt()})}function c(){t.divListMyTeams.html(MAINMODULE.Default.SpinnerTop);$.get("/team/list/mine",function(n){t.divListMyTeams.html(n)}).done(function(){console.info("my teams loaded")})}function ht(){t.container.html(MAINMODULE.Default.Spinner);$.get(l+"/new",function(n){t.container.html(n);f();r();h();$.validator.unobtrusive.parse(t.form)})}function ct(n){t.container.html(MAINMODULE.Default.Spinner);$.get(n,function(n){t.container.html(n);e();f();r();h();$.validator.unobtrusive.parse(t.form)})}function lt(){t.divGamesList.html(MAINMODULE.Default.SpinnerTop);var n=t.divGames.data("id");$.get("/game/byteam/"+n,function(n){t.divGamesList.html(n)})}function at(t){var i=$(n.teamMemberTemplate).first().clone(),u=[],f,s,h,c,l,a;if($(n.teamMemberUserId).each(function(n,t){u.push(t.value)}),f=u.indexOf(t.id)>-1,f){ALERTSYSTEM.ShowWarningMessage("The user you selected is already added to this team!");return}s=i.find("[id$=__UserId]");s.val(t.id);h=i.find(".avatar");h.attr("src",o+t.id);c=i.find(n.teamMemberIsLeader);c.remove();l=i.find(n.teamMemberName);l.text(t.text);a=i.find(".team-member-name-hidden");a.val(t.text);i.removeClass("template");i.appendTo(n.divMembers);e();r()}function vt(n){if(!n.id)return n.text;return $('<span><img class="rounded-circle lazyload avatar" data-src="'+o+n.id+'" src="/images/profileimages/developer.png" alt="meh"> '+n.text+"<\/span>")}function f(){t.form=$(n.formSaveTeam);t.ddlSearchMembers=$(n.ddlSearchMembers);t.divMembers=$(n.divMembers);t.teamMember=$(n.teamMember)}function yt(){$("[data-toggle='popover']").each(function(n,t){var i=$(t).data(),r,u;i.target&&(r=i.target,u=$(r).html(),i.content=u,i.html=!0);$(t).popover(i)})}function pt(n){var i=t.form.attr("action"),r=t.form.serialize();$.post(i,r).done(function(t){t.success===!0?(MAINMODULE.Common.PostSaveCallback(t,n),ALERTSYSTEM.ShowSuccessMessage(t.message,function(){window.location=t.url})):ALERTSYSTEM.ShowWarningMessage("An error occurred! Check the console!")})}function e(){var i=0;t.divMembers.find(n.teamMember).each(function(){$(this).find(":input").each(function(){var n=$(this).attr("id"),t=$(this).attr("name"),r,u,f,e;n!==undefined&&t!==undefined&&(r=n.split("__")[1],u=a.replace("0",i)+r,$(this).attr("id",u),f=t.split("].")[1],e=v.replace("0",i)+f,$(this).attr("name",e))});i++})}var l="/team",o="/storage/userimage/ProfileImage/",a="Members_0__",v="Members[0].",n={},t={},s=!1,i=!1,u=!1;return{Init:b}}();$(function(){TEAMUP.Init()});
