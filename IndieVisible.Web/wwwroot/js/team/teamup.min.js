var TEAMUP=function(){"use strict";function v(){n.container="#teamcontainer";n.isAjax="#isajax";n.caninteract="#caninteract";n.divListTeams="#divListTeams";n.divListMyTeams="#divListMyTeams";n.btnTeamNew=".btn-team-new";n.teamMemberTemplate=".team-member.template";n.formSaveTeam="#frmTeamSave";n.btnSaveTeam="#btnSaveTeam";n.divteamItem=".team-item";n.divMembers="#divMembers";n.teamMember=".team-member";n.teamMemberUserId=".team-member:not(.template) .team-member-userid";n.teamMemberIsLeader=".team-member-isleader";n.teamMemberName=".team-member-name";n.ddlSearchMembers="#ddlSearchMembers";n.divDetails=".div-details";n.divInvitation="#divInvitation";n.txtMyQuote="#txtMyQuote";n.btnAcceptInvitation="#btnAcceptInvitation";n.btnRejectInvitation="#btnRejectInvitation";n.btnEditTeam=".btnEditTeam";n.btnDeleteTeam=".btnDeleteTeam";n.btnDeleteMember=".btnDeleteMember";n.divGames="#divGames";n.divGamesList="#divGamesList"}function y(){t.container=$(n.container);t.divListTeams=$(n.divListTeams);t.divListMyTeams=$(n.divListMyTeams);t.divInvitation=$(n.divInvitation);t.divGames=$(n.divGames);t.divGamesList=$(n.divGamesList);o||(u(),t.txtMyQuote=$(n.txtMyQuote))}function p(){v();y();w();o=$(n.container).find(n.isAjax).val();i=$(n.container).find(n.caninteract).val();t.container.find(n.caninteract).val();rt();h();t.divGames.length>0&&et()}function w(){b();k();d();g();nt();tt();it()}function r(){$(n.divMembers+" select.select2").each(function(){$(this).data("select2")===undefined&&$(this).select2({width:"element"})})}function s(){t.ddlSearchMembers.select2({minimumInputLength:2,templateResult:st});t.ddlSearchMembers.on("select2:select",function(n){var t=n.params.data;$(this).val(null).trigger("change");ot(t)})}function b(){t.container.on("click",n.btnTeamNew,function(){i&&ut()})}function k(){t.container.on("click",n.btnSaveTeam,function(){var n=t.form.valid();n&&i&&ct()})}function d(){t.divMembers.on("click",n.btnAcceptInvitation,function(){var r=$(this),u=$(this).data("url"),i=t.txtMyQuote.val(),f={quote:i};$.post(u,f).done(function(){var u=r.closest(n.divDetails).find(".quote");u.text(i);u.removeClass("d-none");t.divInvitation.remove()})})}function g(){t.divMembers.on("click",n.btnRejectInvitation,function(){var t=$(this),i=$(this).data("url");$.post(i).done(function(){t.closest(n.teamMember).remove()})})}function nt(){t.divListTeams.on("click",n.btnEditTeam,function(n){n.preventDefault();var t=$(this).data("url");i&&ft(t)})}function tt(){t.divListTeams.on("click",n.btnDeleteTeam,function(t){t.preventDefault();var i=$(this),r=$(this).data("url"),u=i.data("confirmationmessage"),f=i.data("confirmationtitle"),e=i.data("confirmationbuttontext"),o=i.data("cancelbuttontext");ALERTSYSTEM.ShowConfirmMessage(f,u,e,o,function(){$.ajax({url:r,type:"DELETE"}).done(function(t){t.success?(i.closest(n.divteamItem).remove(),h(),t.message&&ALERTSYSTEM.ShowSuccessMessage(t.message)):ALERTSYSTEM.ShowWarningMessage(t.message)})})})}function it(){t.container.on("click",n.btnDeleteMember,function(t){t.preventDefault();var i=$(this),r=$(this).data("url"),u=i.data("confirmationmessage"),e=i.data("confirmationtitle"),o=i.data("confirmationbuttontext"),s=i.data("cancelbuttontext");ALERTSYSTEM.ShowConfirmMessage(e,u,o,s,function(){$.ajax({url:r,type:"DELETE"}).done(function(t){t.success?(i.closest(n.teamMember).remove(),f(),t.message&&ALERTSYSTEM.ShowSuccessMessage(t.message)):ALERTSYSTEM.ShowWarningMessage(t.message)})})})}function rt(){t.divListTeams.html(MAINMODULE.Default.Spinner2);$.get("/team/list/",function(n){t.divListTeams.html(n)}).done(function(){ht()})}function h(){t.divListMyTeams.html(MAINMODULE.Default.Spinner2);$.get("/team/list/mine",function(n){t.divListMyTeams.html(n)}).done(function(){console.log("my teams loaded")})}function ut(){t.container.html(MAINMODULE.Default.Spinner);$.get(c+"/new",function(n){t.container.html(n);u();r();s();$.validator.unobtrusive.parse(t.form)})}function ft(n){t.container.html(MAINMODULE.Default.Spinner);$.get(n,function(n){t.container.html(n);f();u();r();s();$.validator.unobtrusive.parse(t.form)})}function et(){t.divGamesList.html(MAINMODULE.Default.Spinner2);var n=t.divGames.data("id");$.get("/game/byteam/"+n,function(n){t.divGamesList.html(n)})}function ot(t){var i=$(n.teamMemberTemplate).first().clone(),u=[],o,s,h,c,l,a;if($(n.teamMemberUserId).each(function(n,t){u.push(t.value)}),o=u.indexOf(t.id)>-1,o){ALERTSYSTEM.ShowWarningMessage("The user you selected is already added to this team!");return}s=i.find("[id$=__UserId]");s.val(t.id);h=i.find(".avatar");h.attr("src",e+t.id);c=i.find(n.teamMemberIsLeader);c.remove();l=i.find(n.teamMemberName);l.text(t.text);a=i.find(".team-member-name-hidden");a.val(t.text);i.removeClass("template");i.appendTo(n.divMembers);f();r()}function st(n){if(!n.id)return n.text;return $('<span><img class="rounded-circle lazyload avatar" data-src="'+e+n.id+'" src="/images/profileimages/developer.png" alt="meh"> '+n.text+"<\/span>")}function u(){t.form=$(n.formSaveTeam);t.ddlSearchMembers=$(n.ddlSearchMembers);t.divMembers=$(n.divMembers);t.teamMember=$(n.teamMember)}function ht(){$("[data-toggle='popover']").each(function(n,t){var i=$(t).data(),r,u;i.target&&(r=i.target,u=$(r).html(),i.content=u,i.html=!0);$(t).popover(i)})}function ct(n){var i=t.form.attr("action"),r=t.form.serialize();$.post(i,r).done(function(t){t.success===!0?(n&&n(),ALERTSYSTEM.ShowSuccessMessage("Awesome!",function(){window.location=t.url})):ALERTSYSTEM.ShowWarningMessage("An error occurred! Check the console!")})}function f(){var i=0;t.divMembers.find(n.teamMember).each(function(){$(this).find(":input").each(function(){var n=$(this).attr("id"),t=$(this).attr("name"),r,u,f,e;n!==undefined&&t!==undefined&&(r=n.split("__")[1],u=l.replace("0",i)+r,$(this).attr("id",u),f=t.split("].")[1],e=a.replace("0",i)+f,$(this).attr("name",e))});i++})}var c="/team",e="/storage/userimage/ProfileImage/",l="Members_0__",a="Members[0].",n={},t={},o=!1,i=!1;return{Init:p}}();$(function(){TEAMUP.Init()});
