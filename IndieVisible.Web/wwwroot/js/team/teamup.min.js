var TEAMUP=function(){"use strict";function v(){n.container="#teamcontainer";n.isAjax="#isajax";n.caninteract="#caninteract";n.divListTeams="#divListTeams";n.divListMyTeams="#divListMyTeams";n.btnTeamNew=".btn-team-new";n.teamMemberTemplate=".team-member.template";n.formSaveTeam="#frmTeamSave";n.btnSaveTeam="#btnSaveTeam";n.divteamItem=".team-item";n.divMembers="#divMembers";n.teamMember=".team-member";n.teamMemberUserId=".team-member:not(.template) .team-member-userid";n.teamMemberIsLeader=".team-member-isleader";n.teamMemberName=".team-member-name";n.ddlSearchMembers="#ddlSearchMembers";n.divDetails=".div-details";n.divInvitation="#divInvitation";n.txtMyQuote="#txtMyQuote";n.btnAcceptInvitation="#btnAcceptInvitation";n.btnRejectInvitation="#btnRejectInvitation";n.btnEditTeam=".btnEditTeam";n.btnDeleteTeam=".btnDeleteTeam"}function y(){t.container=$(n.container);t.divListTeams=$(n.divListTeams);t.divListMyTeams=$(n.divListMyTeams);t.divInvitation=$(n.divInvitation);e||(u(),t.txtMyQuote=$(n.txtMyQuote))}function p(){v();y();w();e=$(n.container).find(n.isAjax).val();i=$(n.container).find(n.caninteract).val();t.container.find(n.caninteract).val();it();s()}function w(){b();k();d();g();nt();tt()}function r(){$(n.divMembers+" select.select2").each(function(){$(this).data("select2")===undefined&&$(this).select2({width:"element"})})}function o(){t.ddlSearchMembers.select2({minimumInputLength:2,templateResult:et});t.ddlSearchMembers.on("select2:select",function(n){var t=n.params.data;$(this).val(null).trigger("change");ft(t)})}function b(){t.container.on("click",n.btnTeamNew,function(){i&&rt()})}function k(){t.container.on("click",n.btnSaveTeam,function(){var n=t.form.valid();n&&i&&st()})}function d(){t.divMembers.on("click",n.btnAcceptInvitation,function(){var r=$(this),u=$(this).data("url"),i=t.txtMyQuote.val(),f={quote:i};$.post(u,f).done(function(){var u=r.closest(n.divDetails).find(".quote");u.text(i);u.removeClass("d-none");t.divInvitation.remove()})})}function g(){t.divMembers.on("click",n.btnRejectInvitation,function(){var t=$(this),i=$(this).data("url");$.post(i).done(function(){t.closest(n.teamMember).remove()})})}function nt(){t.divListTeams.on("click",n.btnEditTeam,function(n){n.preventDefault();var r=$(this),t=$(this).data("url");i&&ut(t)})}function tt(){t.divListTeams.on("click",n.btnDeleteTeam,function(t){t.preventDefault();var i=$(this),r=$(this).data("url"),u=i.data("confirmationmessage"),f=i.data("confirmationtitle"),e=i.data("confirmationbuttontext"),o=i.data("cancelbuttontext");ALERTSYSTEM.ShowConfirmMessage(f,u,e,o,function(){$.ajax({url:r,type:"DELETE"}).done(function(t){t.success?(i.closest(n.divteamItem).remove(),s(),t.message&&ALERTSYSTEM.ShowSuccessMessage(t.message)):ALERTSYSTEM.ShowWarningMessage(t.message)})})})}function it(){t.divListTeams.html(MAINMODULE.Default.Spinner2);$.get("/team/list/",function(n){t.divListTeams.html(n)}).done(function(){ot()})}function s(){t.divListMyTeams.html(MAINMODULE.Default.Spinner2);$.get("/team/list/mine",function(n){t.divListMyTeams.html(n)}).done(function(){console.log("my teams loaded")})}function rt(){t.container.html(MAINMODULE.Default.Spinner);$.get(c+"/new",function(n){t.container.html(n);u();r();o();$.validator.unobtrusive.parse(t.form)})}function ut(n){t.container.html(MAINMODULE.Default.Spinner);$.get(n,function(n){t.container.html(n);h();u();r();o();$.validator.unobtrusive.parse(t.form)})}function ft(t){var i=$(n.teamMemberTemplate).first().clone(),u=[],e,o,s,c,l,a;if($(n.teamMemberUserId).each(function(n,t){u.push(t.value)}),e=u.indexOf(t.id)>-1,e){ALERTSYSTEM.ShowWarningMessage("The user you selected is already added to this team!");return}o=i.find("[id$=__UserId]");o.val(t.id);s=i.find(".avatar");s.attr("src",f+t.id);c=i.find(n.teamMemberIsLeader);c.remove();l=i.find(n.teamMemberName);l.text(t.text);a=i.find(".team-member-name-hidden");a.val(t.text);i.removeClass("template");i.appendTo(n.divMembers);h();r()}function et(n){if(!n.id)return n.text;return $('<span><img class="rounded-circle lazyload avatar" data-src="'+f+n.id+'" src="/images/profileimages/developer.png" alt="meh"> '+n.text+"<\/span>")}function u(){t.form=$(n.formSaveTeam);t.ddlSearchMembers=$(n.ddlSearchMembers);t.divMembers=$(n.divMembers);t.teamMember=$(n.teamMember)}function ot(){$("[data-toggle='popover']").each(function(n,t){var i=$(t).data(),r,u;i.target&&(r=i.target,u=$(r).html(),i.content=u,i.html=!0);$(t).popover(i)})}function st(n){var i=t.form.attr("action"),r=t.form.serialize();$.post(i,r).done(function(t){t.success===!0?(n&&n(),ALERTSYSTEM.ShowSuccessMessage("Awesome!",function(){window.location=t.url})):ALERTSYSTEM.ShowWarningMessage("An error occurred! Check the console!")})}function h(){var i=0;t.divMembers.find(n.teamMember).each(function(){$(this).find(":input").each(function(){var n=$(this).attr("id"),t=$(this).attr("name"),o=$(this).val(),r,u,f,e;n!==undefined&&t!==undefined&&(r=n.split("__")[1],u=l.replace("0",i)+r,$(this).attr("id",u),f=t.split("].")[1],e=a.replace("0",i)+f,$(this).attr("name",e))});i++})}var c="/team",f="/storage/userimage/ProfileImage/",l="Members_0__",a="Members[0].",n={},t={},e=!1,i=!1;return{Init:p}}();$(function(){TEAMUP.Init()});
